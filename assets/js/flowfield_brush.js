...
let DISPLAY_SIZE_X = 800;
let DISPLAY_SIZE_Y = DISPLAY_SIZE_X;
...
function setup() {
  windowResized();
  var canvas = createCanvas(DISPLAY_SIZE_X, DISPLAY_SIZE_Y);
...
function mouseDragged() {
  if (mouseX > 0 && mouseX < DISPLAY_SIZE_X && mouseY > 0 && mouseY < DISPLAY_SIZE_Y)
  {
...
function windowResized() {
  var div = document.getElementById('div-canvas');
  if (div != null) {
      DISPLAY_SIZE_X = div.offsetWidth;
      resizeCanvas(DISPLAY_SIZE_X, DISPLAY_SIZE_Y);
  }
}
